...
from protos import f1_pb2 as protos_dot_f1__pb2
...
if _version_not_supported:
    raise RuntimeError(
        ...
        + ' but the generated code in protos/f1_pb2_grpc.py depends on'
...
class MonitoramentoStub(object):
...
def add_MonitoramentoServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'f1.Monitoramento', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('f1.Monitoramento', rpc_method_handlers)
